...
<div id="main"> <a href="#"><img src="images/logo1.gif" alt="" border="0" class="logo"  /></a>
  ...
  $ob=new query();
  $src="from";
  $rs=$ob->readcourier($did,$src,1);
 if(mysqli_num_rows($rs)<1)
{
?>
<p align="center" style="color:red;font:bold 13px Tahoma">NO NEW ORDERS !</p>
<?php
}
else
{?>
<tr  bgcolor="#990000" style="color:white;font:bold 13px Tahoma"><th>C-ID</th><th>DATE</th><th>SENDER</th><th>RECIEVER</th><th>ITEM</th><th>WEIGHT</th><th>DELIVERY</th><th>AMOUNT</th><th>TO</th><th>STATUS</th><th>ACTION</th></tr>
<?php
...
<a style="color:white;text-decoration:none;background:#4CAF50" href="statusprocess.php?id=<?php echo $r[0]; ?>&sts=1&pg=2">APPROVE</a><br><br><a style="color:white;text-decoration:none;background:red"href="statusprocess.php?id=<?php echo $r[0]; ?>&sts=4&pg=2">REJECT</a></td></tr>
<?php }
elseif($r[10]==1)
{?>
ON TRANSIT</td><td>
<a style="color:white;text-decoration:none;background:orange;" href="statusprocess.php?id=<?php echo $r[0]; ?>&sts=4&pg=2">CANCEL</a></td></tr>
<?php
}
elseif($r[10]==2)
{
?>
WAITING FOR RECIEVER</td><td><a style="color:white;text-decoration:none;background:orange"href="statusprocess.php?id=<?php echo $r[0]; ?>&sts=4&pg=2">CANCEL</a></td></tr>
 <?php
  }
  elseif($r[10]==3)
{
...
{
?>
CANCELLED</td><td><a style="color:red;text-decoration:none;background:#2196F3"href="statusprocess.php?id=<?php echo $r[0]; ?>&sts=0&pg=2">RESEND</a></td></tr>
 <?php
}
?>
